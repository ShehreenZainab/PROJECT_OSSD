"""
TeddyShine Laundry Management System - Login Window Module
Color Theme: Light Greenish-Gray (#E8F0E6 background style)
Module: login_window.py
Purpose: First screen - lets users log in or sign up
"""
...
from utils.helpers import show_error, show_success, center_window, validate_email, validate_phone, safe_int


class LoginWindow(tk.Frame):
    """
    Login Window - Entry screen for TeddyShine Laundry Management System.
    ...
    COLORS = {
        ...
        'primary': '#2E7D32',       # Dark green for buttons/headers
        'primary_light': '#4CAF50',  # Lighter green for hover
        'secondary': '#81C784',      # Soft green for accents
        'text': '#1B5E20',           # Dark green text
        'text_light': '#F5F5F5',     # Light text for buttons
    ...
    def __init__(self, parent, switch_callback):
        ...
        Args:
            parent: The root window (tk.Tk)
            switch_callback: Function to call after successful login to switch to dashboard
        """
    ...
    def create_main_container(self):
        """Creates the main centered container for the login form."""
        # Main frame (centered)
        ...
        # Create Notebook (Tabs) for Login and Sign Up
        self.create_tabs()
        
    def create_header(self):
        """Creates the app header with logo and title."""
        # Logo placeholder (using text emoji for now)
    ...
    def create_tabs(self):
        ...
        self.notebook.pack(padx=30, pady=10, fill='both', expand=True)
